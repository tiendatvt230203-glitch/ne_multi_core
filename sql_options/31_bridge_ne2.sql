...
(
    ...
    ARRAY['172.16.2.2/32']::text[], FALSE,
    ARRAY['172.16.2.1/32']::text[], FALSE,
    ARRAY['7013']::text[], NULL,
    'pqc-gcm', NULL
),
(
    11, 31, 11, 'bypass', NULL,
    NULL, FALSE,
    NULL, FALSE,
    NULL, NULL,
    NULL, NULL
...
INSERT INTO ne_wan (interface, profile_id, dst_ip, weight) VALUES
    ('eno3', 31, NULL, 50),
    ('eno4', 31, NULL, 50),
    ('enp7s0',31, '192.168.11.2/24', NULL);
